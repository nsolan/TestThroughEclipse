...
/*	@Test(expected=com.capgemini.exceptions.InvalidAccountNumberException.class)
	public void whenTheAccountIsInvalidThanthrowException() throws InvalidAccountNumberException
	{
		Account account =new Account();
		account.setAccountNumber(101);
		account.setAmount(5000);
	...
	*/
	@Test
	public void whenTheValidAccountNumberPassedDepositAmountSuccessfully() throws InvalidAccountNumberException
	{
		Account account=new Account();
		account.setAccountNumber(101);
		account.setAmount(5000);
	...
	public void whenInsufficientAmountWithdrawThrowException() throws InsufficientBalanceException
	{
		accountRepository.searchAccount(101).getAmount();
	}*/
	
	@Test
	public void whenTheValidAmountWithdrawalAmountShouldWithdrawSuccessfully() throws InvalidAccountNumberException,InsufficientBalanceException
	{
		Account account=new Account();
		account.setAccountNumber(101);
		account.setAmount(5000);
		when(accountRepository.searchAccount(101)).thenReturn(account);
		assertEquals(account.getAmount()-200, accountService.withdrawAmount(101, 200));
